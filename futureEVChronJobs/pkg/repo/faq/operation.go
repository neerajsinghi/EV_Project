...
func (r *repo) FindOne(filter, projection bson.M) (entity.FAQDB, error) {
	var profile entity.FAQDB
...
func (r *repo) Find(filter, projection bson.M) ([]entity.FAQDB, error) {
	var profiles []entity.FAQDB
