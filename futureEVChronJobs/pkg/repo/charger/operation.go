...
func (r *repo) FindOne(filter, projection bson.M) (entity.ChargerDB, error) {
	var profile entity.ChargerDB
...
func (r *repo) Find(filter, projection bson.M) ([]entity.ChargerDB, error) {
	var profiles []entity.ChargerDB
