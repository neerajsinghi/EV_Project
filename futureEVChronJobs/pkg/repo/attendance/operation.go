...
func (r *repo) FindOne(filter, projection bson.M) (entity.UserAttendance, error) {
	var profile entity.UserAttendance
...
func (r *repo) Find(filter, projection bson.M) ([]entity.UserAttendance, error) {
	var profiles []entity.UserAttendance
