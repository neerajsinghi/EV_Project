...
func (r *repo) FindOne(filter, projection bson.M) (entity.Notification, error) {
	var profile entity.Notification
...
func (r *repo) Find(filter, projection bson.M) ([]entity.Notification, error) {
	var profiles []entity.Notification
