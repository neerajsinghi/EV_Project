...
func (r *repo) FindOne(filter, projection bson.M) (*entity.City, error) {
	var profile *entity.City
...
func (r *repo) Find(filter, projection bson.M) ([]entity.City, error) {
	var profiles []entity.City
...
func (r *repo) Aggregate(pipeline bson.A) ([]interface{}, error) {
