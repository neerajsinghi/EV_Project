...
func GetUsers(w http.ResponseWriter, r *http.Request) {
	...
	utils.SendOutput(err, w, r, data, "GetUsers")
}
...
func GetUserById(w http.ResponseWriter, r *http.Request) {
	...
	utils.SendOutput(err, w, r, data, "GetUserById")
}
...
func UpdateUser(w http.ResponseWriter, r *http.Request) {
	...
	utils.SendOutput(err, w, r, data, "UpdateUser")
...
func DeleteUser(w http.ResponseWriter, r *http.Request) {
	...
	utils.SendOutput(err, w, r, nil, "DeleteUser")
}
...
func DeleteUserPermanently(w http.ResponseWriter, r *http.Request) {
	...
	utils.SendOutput(err, w, r, nil, "DeleteUserPermanently")
}
...
func RemovePlan(w http.ResponseWriter, r *http.Request) {
	...
	utils.SendOutput(err, w, r, data, "RemovePlan")
}
