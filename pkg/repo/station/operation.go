...
func (r *repo) FindOne(filter, projection bson.M) (entity.StationDB, error) {
	var profile entity.StationDB
...
func (r *repo) Find(filter, projection bson.M) ([]entity.StationDB, error) {
	var profiles []entity.StationDB
...
func (r *repo) Aggregate(pipeline bson.A) ([]entity.StationDB, error) {
	var profiles []entity.StationDB
