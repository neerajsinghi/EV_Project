...
func (r *repo) FindOne(filter, projection bson.M) (entity.ServiceDB, error) {
	var profile entity.ServiceDB
...
func (r *repo) Find(filter, projection bson.M) ([]entity.ServiceDB, error) {
	var profiles []entity.ServiceDB
