...
func (r *repo) FindOne(filter, projection bson.M) (entity.PlanDB, error) {
	var profile entity.PlanDB
...
func (r *repo) Find(filter, projection bson.M) ([]entity.PlanDB, error) {
	var profiles []entity.PlanDB
